...
public class LogbookMealsPerMonthTest {
	private Logger logger = LoggerFactory.getLogger(LogbookMealsPerMonthTest.class);
//	private DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy.MM.dd");
	...
	void createByStringJanuary() {
		...
		logger.info(result);
		assertTrue(result.contains("- 2020.01.31 Fr  ."));
		assertTrue(result.contains("- 2020.01.01 We  .  (New Year's Day)"));
	}
	...
	void createByStringDecember() {
		...
		logger.info(result);
		assertTrue(result.contains("- 2020.12.31 Th  .  (New Year's Eve)"));
		assertTrue(result.contains("- 2020.12.01 Tu  ."));
		assertTrue(result.contains("- 2020.12.24 Th  .  (Christmas Eve)"));
		assertTrue(result.contains("- 2020.12.25 Fr  .  (Christmas Day)"));
		assertTrue(result.contains("- 2020.12.26 Sa  .  (Second Day of Christmas)"));
	}
